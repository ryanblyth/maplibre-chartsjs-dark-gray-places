...
2. Deploy the static set described in [docs/deploying.md](docs/deploying.md), including at minimum for the full preview: `preview.html`, `style.css`, `map.js`, `map-config.js`, `style.json`, `sprites/`, `charts/`, `data/`, `charts-dock-panel.js`, `charts-dock-resize.js`, `charts-dock-search.js`, and `shared/utils/*.js`.
